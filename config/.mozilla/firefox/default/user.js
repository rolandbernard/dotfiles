...
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[],\"unified-extensions-area\":[\"languagetool-webextension_languagetool_org-browser-action\",\"treestyletab_piro_sakura_ne_jp-browser-action\",\"addon_darkreader_org-browser-action\",\"firefoxcolor_mozilla_com-browser-action\"],\"nav-bar\":[\"back-button\",\"forward-button\",\"stop-reload-button\",\"sidebar-button\",\"vertical-spacer\",\"customizableui-special-spring1\",\"urlbar-container\",\"customizableui-special-spring2\",\"ublock0_raymondhill_net-browser-action\",\"downloads-button\",\"library-button\",\"unified-extensions-button\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[\"firefox-view-button\",\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"vertical-tabs\":[],\"PersonalToolbar\":[\"personal-bookmarks\"]},\"seen\":[\"save-to-pocket-button\",\"developer-button\",\"ublock0_raymondhill_net-browser-action\",\"languagetool-webextension_languagetool_org-browser-action\",\"treestyletab_piro_sakura_ne_jp-browser-action\",\"addon_darkreader_org-browser-action\",\"profiler-button\",\"firefoxcolor_mozilla_com-browser-action\",\"screenshot-button\"],\"dirtyAreaCache\":[\"nav-bar\",\"unified-extensions-area\",\"TabsToolbar\",\"toolbar-menubar\",\"PersonalToolbar\",\"vertical-tabs\"],\"currentVersion\":23,\"newElementCount\":8}");
