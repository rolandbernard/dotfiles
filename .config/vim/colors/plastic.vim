...
let s:backgroundline = {'gui': '#252930', 'cterm256': '235'}
let s:backgroundcolumn = {'gui': '#2d323a', 'cterm256': '235'}
...
call <sid>hi('CursorColumn', s:none, s:backgroundcolumn, 'none', {})
...
call <sid>hi('DiffText', s:grey, s:background, 'none', {})
